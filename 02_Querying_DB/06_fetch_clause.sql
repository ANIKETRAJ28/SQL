...
-- to skip a certain number of rows and retrieve a specific number of rows, 
-- you often use the LIMIT clause in the SELECT statement
-- but LIMIT clause is not sql standard
-- postgresql has FETCH clause to skip a certain number of rows and then fetch a specific number of rows
